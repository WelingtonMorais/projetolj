...
<link rel="shortcut icon" href="img/lj.jpg" />
...
if(isset($_POST['button'])){
	...
	if($code == ''){
		echo "<h2> Por favor, digite o e-mail de acesso! </h2>";
		}
		...
		if(mysqli_num_rows($result) > 0){
			...
			while($res_1 = mysqli_fetch_assoc($result)){
				...
				if($status == 'Inativo'){
					...
					if($painel == 'lejardin'){
						header('Location: lejardin.php');	
						//abaixo estão o restante das condições para o próximos condomínios...use o Header para direcionar as paginas pelo amor de Deus
